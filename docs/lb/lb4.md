# Лабораторна робота № 4. Інтеграція хмарних NoSQL баз даних (AWS DynamoDB) засобами Python SDK (Boto3): проєктування схем, оптимізація індексів та бенчмаркінг запитів Scan проти Query
